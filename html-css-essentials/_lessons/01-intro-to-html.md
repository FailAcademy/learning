...
layout: lesson
title: Intro to HTML
slides: ['_slides/01-intro-to-html-slides.md']
---
...
- Use basic HTML elements including headings, paragraphs, links, lists, and images.
...
For homework, please begin marking-up the HTML for your Project 1.
...
Use what we've learned about paragraphs, headings, lists, links, and images to rough-out the structure of the site. You don't need to worry about the table or the Google Map at this time unless you're feeling ambitious!
...
It's OK if it doesn't look beautiful yet! We'll start learning about CSS in the next class.
