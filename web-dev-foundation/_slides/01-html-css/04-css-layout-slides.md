...
1. CSS positioning (static, relative, absolute, and fixed)
2. CSS floats/clear floats
3. Standard Layout Practices
4. Apply CSS Reset
5. Styling HTML lists (ordered & unordered)
...
Building a great design layout for your website takes some thought, planning and careful execution. Take a look at different sites for examples, but start with a **clean, simple layout**. Some important principles to consider include choosing and sticking to an alignment, setting your whitespace properly and highlighting important elements through size, positioning, and CSS styling.

**Let's take a look at [10 Common Layout Styles](http://designshack.net/articles/layouts/10-rock-solid-website-layout-examples/)**
---
## Sample HTML5 Layout Tags

.inline-images[![Balsamiq Wireframe](../../public/img/slide-assets/html5-semantic-tags.png)]
